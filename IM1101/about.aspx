<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="about.aspx.cs" Inherits="IM1101.about" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>甘飲涼香醇茶飲 - 關於甘飲涼</title>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    <h1>關於甘飲涼</h1>
                    <p>
                        我們甘飲涼飲料店創立於2020年在龍華科技大學裡，在炎炎夏日中更是學生與老師夏天最消暑解渴的必備品，在冬天寒冷的天氣裡也能感受到溫暖，甘飲涼也會一步一腳印，堅守品質與服務，並且把衛生做到最好，打造出校園知名飲料店。
                    </p>
                </div>
                <div class="col-md-4">
                    <img src="assets/img/GAN_YIN .jpg" alt="關於甘飲涼 Hero" width="300" height="300">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    <div class="h1 text-success text-center"><img src="assets/img/GAN.png" i class="fas fa-exchange-alt""></i></div>
                    <h2 class="h5 mt-4 text-center">主打茶葉現泡，尾韻回甘</h2>
                </div>
          </div>
            ...
            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    <div class="h1 text-success text-center"><img src="assets/img/YIN.png" i class="fas fa-exchange-alt""></i></div>
                    <h2 class="h5 mt-4 text-center">好喝到讓您痛快暢飲</h2>
                </div>
            </div>

            <div class="col-md-6 col-lg-3 pb-5">
                <div class="h-100 py-5 services-icon-wap shadow">
                    <div class="h1 text-success text-center"><img src="assets/img/YIANG .png" i class="fas fa-exchange-alt""></i></div>
                    <h2 class="h5 mt-4 text-center">想消暑解渴就來喝一杯吧</h2>
                </div>
            </div>
        </div>
    </section>
