<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login_no.aspx.cs" Inherits="IM1101.login_no" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>甘飲涼香醇茶飲 - 登入失敗</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container py-5">
        <div class="row py-5">
            <form class="col-md-9 m-auto" method="post" action="./index.aspx" role="form">
                <div class="row">
                ...
                <div class="row">
                    <div class="col text-end mt-2">
                        <button type="submit" class="btn btn-success btn-lg px-3">返回主頁面</button>
                    </div>
                </div>
            </form>
        </div>
