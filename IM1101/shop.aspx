<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shop.aspx.cs" Inherits="IM1101.shop" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>甘飲涼香醇茶飲 - 香醇茶飲</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="assets/css/fontawesome.min.css"></head></head>
<body>
    <!-- Start Top Nav -->
            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA1/10.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">蘋果多輕飲</a>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA1/02.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">蜂蜜檸綠</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA1/03.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                   
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">蜂蜜檸檬蘆薈</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                              <img src="assets/img/TEA1/04.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                   
                                </div>
                            </div>
                            <div class="card-body">
                                  <a  class="h3 text-decoration-none">檸檬愛玉</a>
                              <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA1/05.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">百香愛玉</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA1/06.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">百香輕果飲</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA1/07.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">翡翠檸檬</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA1/08.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">百香多輕飲</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA1/09.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">檸檬多輕飲</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
