<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shop04.aspx.cs" Inherits="IM1101.shop04" %>
            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA4/01.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">蘋果醋冰茶</a>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA4/02.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">蔓越莓冰醋</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA4/03.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                   
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">百年仙草干茶</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                              <img src="assets/img/TEA4/04.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                   
                                </div>
                            </div>
                            <div class="card-body">
                                  <a  class="h3 text-decoration-none">蜜茶</a>
                              <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA4/05.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">古早味冬瓜茶</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA4/06.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">冬瓜檸檬</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA4/07.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">冬瓜觀音</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                ...
                                <p class="text-center mb-0">$35.00</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA4/08.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">繽紛水果茶</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
