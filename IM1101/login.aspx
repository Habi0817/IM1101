<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="IM1101.login" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>甘飲涼香醇茶飲 - 會員登入</title>
    <meta charset="utf-8">
            ...
            <form id="form1" runat="server">
                <div class="row">
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputname">帳號：</label><asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="400px"></asp:TextBox>
&nbsp;
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="userPassword">密碼： <asp:TextBox ID="password" runat="server" Height="30px" TextMode="Password" Width="400px"></asp:TextBox>
                        </label>
                        &nbsp;</div>
                </div>
                <div class="col text-end mt-2">
                        <asp:Button ID="Button1" runat="server" Text="登入" BackColor="#59AB6E" BorderStyle="None" Font-Bold="True" Font-Names="微軟正黑體" ForeColor="White" Height="43px" OnClick="Button1_Click" Width="76px" />
                    </div>
               ...
               <br/>
                <div class="row">
               <h2 class="h4">還不是會員？</h4>
                立即註冊，成為會員，可享多項便利服務與最新優惠訊息通知 !
                <div class="row">
                <p type="text-center"> <a class="btn btn-success" href=signup.aspx>立即點我註冊＞＞<a> </p>
