<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login_success.aspx.cs" Inherits="IM1101.login_success" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>甘飲涼香醇茶飲 - 登入成功</title>
    <meta charset="utf-8">
            ...
            <form id="form1" runat="server">
                <div class="row">
                    <!-- <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control mt-1" id="name" name="name" placeholder="帳號">
                    </div>
                    <div class="form-group col-md-6 mb-3">
                        <label for="inputemail">密碼</label>
                        <input type="email" class="form-control mt-1" id="email" name="email" placeholder="密碼">
                    </div> -->
                    <div>
                        <br>登入成功！</br>
                    </div>
                ...
                <div class="row">
                    <div class="col text-end mt-2">
                        <asp:Button ID="Button1" runat="server" BackColor="#59AB6E" BorderStyle="None" Font-Bold="True" Font-Names="微軟正黑體" Font-Strikeout="False" ForeColor="White" Height="41px" OnClick="Button1_Click" Text="進入會員優惠" Width="138px" />
                    </div>
                </div>
            </form>
        </div>
