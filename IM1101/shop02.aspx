<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shop02.aspx.cs" Inherits="IM1101.shop02" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
 <title>甘飲涼香醇茶飲 - 季節限定</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="assets/css/fontawesome.min.css"></head>
</head>
<body>
    <!-- Start Top Nav -->
            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA2/01.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">葚夏青春​</a>
                                ...
                                <p class="text-center mb-0">$65.00</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA2/02.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">春熙柳橙翡翠</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA2/03.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                   
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">愛文芒果冰沙</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                              <img src="assets/img/TEA2/04.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                   
                                </div>
                            </div>
                            <div class="card-body">
                                  <a  class="h3 text-decoration-none">愛文翡翠</a>
                              <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA2/05.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">愛文芒果冰沙Double Double</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                ...
                                <p class="text-center mb-0">$95.00</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA2/06.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">芭梨戀人</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA2/07.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">天天5蔬果汁</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img src="assets/img/TEA2/08.jpg" width="700" height="500" class="card-img rounded-0 img-fluid2">
                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                    
                                </div>
                            </div>
                            <div class="card-body">
                                <a  class="h3 text-decoration-none">番茄梅</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
